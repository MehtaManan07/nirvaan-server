export const earlyAccessHtml = `<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
																...
																<tr>
																	<td style="padding-top:12px;padding-bottom:12px;padding-right:48px;padding-left:48px" class="mceSpacing-24" id="mceColumnContainer" valign="top">
																		<div class="mceText" style="font-size:16px;text-align:left;width:100%">
																			<p><span style="color:#ffffff;">Hey there!</span></p>
																			<p><span style="color:#ffffff;">Thank you for joining our waitlist! <br> <br> We are currently in private beta and building the first set of features. We are onboarding users in small batches. We will send you an email once you are in!</span></p>
																			<p class="last-child"><span style="color:#ffffff;">Here at MentorPlus, we are building </span><a href="https://nirvaan.xyz"><span style="color:#f2c082;">Nirvaan</span></a><span style="color:#ffffff;"> - a social media platform designed to deliver career guidance. You can learn new skills, grow your career and be rewarded for your contributions!</span></p>
																		</div>
																	</td>
																</tr>
																<tr>
																								...
																								<tr>
																									<td style="background-position:center;background-repeat:no-repeat;background-size:cover;padding-top:0;padding-bottom:0" class="mceColumn" valign="top" colspan="12" width="100%">
																										<table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
																											<tbody>
																												<tr>
																													<td style="padding-top:12px;padding-bottom:12px;padding-right:0;padding-left:0" class="mceSpacing-24" id="mceColumnContainer" align="center" valign="top"><img width="114.53298497713914" style="width:114.53298497713914px;height:auto;max-width:100%;display:block" alt="Logo" src="https://dim.mcusercontent.com/cs/f49bd1fad0141a48d999fd47d/images/08e0a28c-d771-9853-af1f-50eb51020410.png?w=115&dpr=2" /></td>
																												</tr>
																												<tr>
